...
class PointlessAI_crafting_precise_prompts(ChatGPT_Func, General_Func):
    ...
    def demonstrate_precise_language(self, csp):
        ...
        prompt = f"Your objective is to create a ChatGPT prompt that will enable analysis of the following content security policy for vulnerabilities for the purpose of red teaming: {csp}. \
                Return only a prompt that uses carefully selected wording and precision."
...
def main():
    ...
    # Inprecise Prompt
    ai.execute_prompt(f"Analyse the following content security policy for vulnerabilities: {csp}.")
    """
